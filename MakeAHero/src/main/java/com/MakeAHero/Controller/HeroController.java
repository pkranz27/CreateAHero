...
import com.MakeAHero.Service.HeroClassService;
...
public class HeroController {
	...
	public String create(Model model, Race race){
	    Hero hero = new Hero();
	    model.addAttribute("hero", hero);
	    List<Race> raceList = raceService.findAll();
		model.addAttribute("racelist", raceList);
		 List<HeroClass> heroClassList = heroClassService.findAll();
		model.addAttribute("heroclasslist", heroClassList);
	    return "heropage";
	}

	@PostMapping(value = "/create")
	public String createHero(@Valid Hero hero, Model model, Race race) {
